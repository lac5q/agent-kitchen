...
- Name: voice-chat.spec.ts >> Voice & Chat panel — Flow page >> Chat tab is active by default and shows placeholder
- Location: e2e/voice-chat.spec.ts:20:7
...
Locator: getByPlaceholder(/Message Memroos Floor/)
Expected: visible
Timeout: 5000ms
