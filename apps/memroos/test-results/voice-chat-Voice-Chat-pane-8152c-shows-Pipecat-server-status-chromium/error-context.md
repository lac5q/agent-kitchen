...
- Name: voice-chat.spec.ts >> Voice & Chat panel — Flow page >> Voice tab is accessible and shows Pipecat server status
- Location: e2e/voice-chat.spec.ts:57:7
    ...
    - generic [ref=e127]:
      ...
      - generic [ref=e216]:
        ...
        - generic [ref=e228]:
          ...
          - button "voice" [active] [ref=e230]
        - paragraph [ref=e232]: Tap the mic and speak to MemroOS system - E2E Caps Agent
        - generic [ref=e233]:
          - button "Start listening" [ref=e234] [cursor=pointer]:
            - img [ref=e235]
          - paragraph [ref=e238]: Tap mic to speak with MemroOS system - E2E Caps Agent
      - generic [ref=e239]:
        - generic [ref=e240]:
