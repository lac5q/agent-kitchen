---
title: Sandboxed Coding-Agent Fleet — Implementation Plan v0.6
date: 2026-07-08
topic: sandbox
model: Hermes (parent) — runsc + WSL2 buildx fixes from real maeve install
sources:
  - maeve setup subagent summary: /Users/lcalderon/.hermes/cache/delegation/subagent-summary-0-20260708_212936_787812.txt
  - canonical fixed install-runsc.sh: /tmp/install-runsc-fixed.sh
derived_from:
  - v0.5: sandboxed-fleet-plan-v0.5-glm-round4-closed-2026-07-08.md
  - v0.4: sandboxed-fleet-plan-v0.4-glm-round3-closed-2026-07-08.md
regen_prompt: Real maeve install on 2026-07-08 surfaced 4 bugs in v0.5: gvisor 'latest' URL returns literal 'latest' (must pin), bucket dir renamed amd64 to x86_64, sha256→sha512, WSL2 buildx default builder fails under sysfs (need docker-container driver builder). Patch all of these into the plan text and add §1b step 7a for the buildx builder.
---
...
## v0.6 → v0.7 (next iteration)

Pending verification on actual boxes. Candidates:
- Complete maeve-u1 build + V2/V3/V4/V10 verifications
- Execute §1a steps 6-9 on oracle-1 (deploy mcp-proxy service)
- Add §1b step 7b to clear stale credsStore from /root/.docker/config.json
- GLM round-5 against v0.6
