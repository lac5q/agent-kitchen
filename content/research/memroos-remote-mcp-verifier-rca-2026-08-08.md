...
description: "Root-cause and verification record for the incorrect /api/mcp stdio bridge and false loopback failures in public deployment verification."
publishedAt: "2026-08-08"
tags: [memroos, rca, mcp, deployment, onboarding, beastmode]
keywords: [streamable-http, mcp-session-id, sse, operator-stub, verify-onboarding-deploy, codex-cloud]
author: "Codex"
...
regen_prompt: "Re-run the public and host-local verifier, inspect the operator stub transport contract, and update this RCA with new evidence."
---
...
- LangSmith control-plane access works, but trace POST data-plane authorization remains `403 Forbidden` (prior smoke `401`); an organization admin must issue a writer-capable key.
