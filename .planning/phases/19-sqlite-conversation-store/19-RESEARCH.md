...
- Directory name is a URL-encoded path, e.g., `-Users-lcalderon-github-agent-kitchen`
...
function deriveAgentId(projectDirName: string): string {
  // e.g. "-Users-lcalderon--paperclip-instances-..." → "paperclip"
...
- Observed JSONL schema: actual file walk of `~/.claude/projects/-Users-lcalderon-github-agent-kitchen/`
