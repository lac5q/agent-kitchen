...
- `deriveAgentId()` correctly decodes Claude project directory names (e.g., `-Users-lcalderon-github-agent-kitchen` → `agent-kitchen`), handles `--` literal-dash encoding and `paperclip` fast-path
