...
decisions:
  ...
  - basePath uses absolute /Users/lcalderon/ prefix (consistent with agent-lightning entries in same file)
...
- Added `{ "name": "knowledge", "category": "other", "basePath": "/Users/lcalderon/github/knowledge" }` to `collections.config.json` (entry 19 of 19)
...
- Fixed `llm-wiki` entry in `collections.config.json` to add `"basePath": "/Users/lcalderon/github/knowledge/llm-wiki/wiki"` — previously pointed at repo root (3 docs), now correctly points at `wiki/` subdir (6+ pages)
...
| `knowledge.basePath === /Users/lcalderon/github/knowledge` | PASS |
