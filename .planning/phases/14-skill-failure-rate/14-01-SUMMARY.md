...
- `/Users/yourname/github/knowledge/scripts/failures_parser.py` — FOUND
- `/Users/yourname/github/knowledge/scripts/tests/test_failures_parser.py` — FOUND
- `/Users/yourname/github/knowledge/scripts/tests/test_skill_sync.py` (modified) — FOUND
