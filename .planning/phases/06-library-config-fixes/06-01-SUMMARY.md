...
- **CONFIG-01:** Fixed `meet-recordings` basePath: `/Users/yourname/knowledge/gdrive/meet-recordings` → `/Users/yourname/github/knowledge/gdrive/meet-recordings` (added `/github` segment — Phase 5 ingestion target)
...
- `alex-docs` and `turnedyellow-admin` retain their `/Users/yourname/knowledge/gdrive/...` basePaths (intentional — different source)
- **Commit:** 265a835
...
- meet-recordings.basePath = /Users/yourname/github/knowledge/gdrive/meet-recordings
