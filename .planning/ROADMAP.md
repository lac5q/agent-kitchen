...
- 🔄 **v8.20 Connected Work Memory** — Phase 176 (added 2026-07-21; **highest priority**; CONNMEM-01..10; CONNMEM-02 canonical envelope + sync ledger schemas LANDED on main commits `3fea2ed7` + `d5dabc47`; CONNMEM-04-prep Linear SDL stub landed; CONNMEM-03..10 adapter implementations explicitly deferred via `CONNMEM-LIVE-DEFER` ticket; 35/35 connmem schema tests pass)
