...
A restaurant-themed observability dashboard for Luis's AI agent infrastructure. Tracks all agents (local + remote), token economics, memory, knowledge bases, APO self-learning cycles, and system flow — with live data from local services. Deployed at kitchen.example.com.
