...
A Next.js dashboard (port 3002, Cloudflare tunnel at `kitchen.epiloguecapital.com`) that makes every agent, knowledge system, and skill visible, connected, and self-improving. It surfaces live agent health, bidirectional knowledge sync, skill contribution analytics, and collapsible flow diagrams in a single UI.
