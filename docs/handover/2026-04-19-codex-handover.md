...
**Production:** `https://kitchen.epiloguecapital.com` (port 3002, `npm start`)  
...
|----|------|---------|----------|-----------|
| `sophia` | Sophia | openclaw | tailscale | 100.101.88.44:18889 |
| `maria` | Maria | hermes | tailscale | 100.109.19.110:8644 |
| `lucia` | Lucia | openclaw | local VPS | localhost:3001 |
| `alba` | Alba | hermes | local Mac | localhost:18793 |
| `gwen` | Gwen | openclaw | cloudflare | gwen.epiloguecapital.com |
