...
This project is indexed by GitNexus as **memroos** (17591 symbols, 40272 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
