...
This project is indexed by GitNexus as **memroos** (16629 symbols, 30948 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
