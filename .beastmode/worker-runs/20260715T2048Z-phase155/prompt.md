...
## Relevant mem0-server.py excerpts
### health + checker + probe cache

### healthcheck Mem0 section (lines 240-272) and alert helpers exist

Implement now. Output unified diffs for allowed files.
